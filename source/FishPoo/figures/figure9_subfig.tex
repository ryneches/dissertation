...
\begin{figure}
    ...
    \subfloat[Eigenvalues of graph Laplacian]{%
        \includegraphics[width=0.5\textwidth]{FishPoo/figures/gopher_louse_eigenvalues}
    }
    \subfloat[Spectral density of eigenvalues]{%
        \includegraphics[width=0.5\textwidth]{FishPoo/figures/gopher_louse_spectral_density}
    }
