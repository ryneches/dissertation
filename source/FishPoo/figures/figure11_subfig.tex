\begin{figure}
    ...
    \subfloat[Permuted spectral densities]{%
        \includegraphics[width=0.5\textwidth]{FishPoo/figures/gopher_louse_spectral_density_permutations}
    }
    \subfloat[Shannon-Jensen distances]{%
        \includegraphics[width=0.5\textwidth]{FishPoo/figures/gopher_louse_spectral_density_permutation_distances}
    }
