\begin{figure}
    ...
    \subfloat[Skew verses eigengap]{%
        \includegraphics[width=0.5\textwidth]{FishPoo/figures/codiv_literature_skew_eigengap.pdf}
    }
    \subfloat[Hierarchical clustering by distance]{%
        \includegraphics[width=0.5\textwidth]{FishPoo/figures/codiv_literature_clustermap.pdf}
    }
