...
\toprule
\textbf{Name} & \textbf{Label} & \textbf{$n$ links} ($n_{L}$) & \textbf{Occupancy} ($k$) & \textbf{Squareness} ($q$) & \textbf{Eigengap} ($\lambda_{\delta}$) & \textbf{Kurtosis} ($\gamma_{2}$) & \textbf{Skew} ($\gamma_{1}$) & \textbf{Hommola cor.} ($r_{H}$) & \textbf{Hommola sig.} ($p_{H}$) & \textbf{treedist} ($D_{t}$) \\ \midrule
